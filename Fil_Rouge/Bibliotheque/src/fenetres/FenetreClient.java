...
public class FenetreClient extends JFrame{
	...
	public FenetreClient() {
		...
		JTextField textFieldTitre;
	 	JTextField textFieldAuteur;
	 	JTextField textFieldTheme;
	 	JTextField textFieldEmplacement;
	 	JTextField textFieldISBN;
	 	JTextField textFieldISSN;
	 	JTextField textFieldNbExemplaireDispo;
	 	JTextField textFieldNbExemplaireDispoBiblio;
	 	JTextArea txtAreaComment;
		 */
	}
