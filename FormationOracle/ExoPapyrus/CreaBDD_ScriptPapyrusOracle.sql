...
(	CODART VARCHAR2(4 BYTE) NOT NULL ENABLE, 
	LIBART VARCHAR2(30 BYTE) NOT NULL ENABLE, 
...
(	NUMFOU NUMBER(10,0) NOT NULL ENABLE, 
	...
	RUEFOU VARCHAR2(35 BYTE) NOT NULL ENABLE, 
	POSFOU VARCHAR2(5 BYTE) NOT NULL ENABLE CONSTRAINT CS_FOURNIS_NUMPOST CHECK (POSFOU >= 01000 AND POSFOU <= 99999 AND LENGTH(POSFOU) = 5), 
	VILFOU VARCHAR2(25 BYTE) NOT NULL ENABLE, 
	CONFOU VARCHAR2(15 BYTE) NOT NULL ENABLE, 
	SATISF NUMBER(2,0) CONSTRAINT CS_FOURNIS_SATISF CHECK (SATISF <= 10 AND SATISF > 0), 
